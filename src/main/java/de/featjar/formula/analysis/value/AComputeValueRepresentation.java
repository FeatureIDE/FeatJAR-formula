...
public abstract class AComputeValueRepresentation<T extends IBooleanRepresentation, U extends IValueRepresentation>
    ...
    public static class OfAssignment extends AComputeValueRepresentation<BooleanAssignment, ValueAssignment> {
    ...
    public static class OfClause extends AComputeValueRepresentation<BooleanClause, ValueClause> {
    ...
    public static class OfSolution extends AComputeValueRepresentation<BooleanSolution, ValueSolution> {
    ...
    public static class OfClauseList extends AComputeValueRepresentation<BooleanClauseList, ValueClauseList> {
    ...
    public static class OfSolutionList extends AComputeValueRepresentation<BooleanSolutionList, ValueSolutionList> {
