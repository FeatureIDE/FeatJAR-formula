...
/**
 * String literals for FeatureIDE XML parser and writer.
 *
 * @author Sebastian Krieter
 */
public class XMLFeatureModelConstants {

    public static final String FEATURE_MODEL = "featureModel";
    public static final String EXT_FEATURE_MODEL = "extendedFeatureModel";
