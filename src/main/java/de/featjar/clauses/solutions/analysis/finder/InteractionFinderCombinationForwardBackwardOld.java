...
public class InteractionFinderCombinationForwardBackwardOld extends InteractionFinderCombination {

    public InteractionFinderCombinationForwardBackwardOld() {
        super(new SingleInteractionFinderOld());
    }
